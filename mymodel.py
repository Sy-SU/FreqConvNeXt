...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='annotations/instances_test20.json',
        backend_args=None,
...
test_evaluator = dict(
    ann_file='data/coco-20/annotations/instances_test20.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
train_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
        ann_file='annotations/instances_train20.json',
        backend_args=None,
...
val_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='annotations/instances_val20.json',
        backend_args=None,
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='data/coco-20/annotations/instances_val20.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
